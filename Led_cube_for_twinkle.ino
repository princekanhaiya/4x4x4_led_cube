//twinkle gift
/*DATA bus: Digital pins 0-7. This corresponds to PORTD 
  Address bus: Digital pins 8-10. This corresponds to PORTB bit 0-2. 
  Output Enable: Digital pin 11. PB3
  Layer transistors: Analog pins 0-5 and digital pins 12 and 13.PORTC N PB4,PB5*/
...
void H() {
  ...
  for (int i = 0; i <= 7; i++) {
    for (int j = 0; j <= 7; j++) {
      setvoxel(i, 0, j);
      delay_ms(200);
      setvoxel(i, 1, j); delay_ms(200);
      setvoxel(i, 6, j); delay_ms(200);
      setvoxel(i, 7, j); delay_ms(200);
      setvoxel(i, 2, 3); delay_ms(200);
      setvoxel(i, 2, 4); delay_ms(200);
      setvoxel(i, 3, 3); delay_ms(200);
      setvoxel(i, 3, 4); delay_ms(200);
      setvoxel(i, 4, 3); delay_ms(200);
      setvoxel(i, 4, 4); delay_ms(200);
      setvoxel(i, 5, 3); delay_ms(200);
      setvoxel(i, 5, 4); delay_ms(200);
    }
  }
}
...
void A() {
  ...
  for (int i = 0; i <= 7; i++) {
    for (int j = 0; j <= 7; j++) {
      setvoxel(i, 0, j); delay_ms(200);
      setvoxel(i, 1, j); delay_ms(200);
      setvoxel(i, 6, j); delay_ms(200);
      setvoxel(i, 7, j); delay_ms(200);
      setvoxel(i, 2, 6); delay_ms(200);
      setvoxel(i, 2, 7); delay_ms(200);
      setvoxel(i, 3, 6); delay_ms(200);
      setvoxel(i, 3, 7); delay_ms(200);
      setvoxel(i, 4, 6); delay_ms(200);
      setvoxel(i, 4, 7); delay_ms(200);
      setvoxel(i, 5, 6); delay_ms(200);
      setvoxel(i, 5, 7); delay_ms(200);
      setvoxel(i, 2, 3); delay_ms(200);
      setvoxel(i, 2, 4); delay_ms(200);
      setvoxel(i, 3, 3); delay_ms(200);
      setvoxel(i, 3, 4); delay_ms(200);
...
void P() {
  ...
  for (int i = 0; i <= 7; i++) {
    for (int j = 2; j <= 7; j++) {
      setvoxel(i, 0, j); delay_ms(200);
      setvoxel(i, 1, j); delay_ms(200);
      setvoxel(i, j, 3); delay_ms(200);
      setvoxel(i, j, 4); delay_ms(200);
      setvoxel(i, 3, 3); delay_ms(200);
      setvoxel(i, 3, 4); delay_ms(200);
      setvoxel(i, 4, 3); delay_ms(200);
      setvoxel(i, 4, 4); delay_ms(200);
      setvoxel(i, 5, 3); delay_ms(200);
      setvoxel(i, 5, 4); delay_ms(200);
      setvoxel(i, 6, 3); delay_ms(200);
      setvoxel(i, 6, 4); delay_ms(200);
      setvoxel(i, 7, 3); delay_ms(200);
      setvoxel(i, 7, 4); delay_ms(200);
      setvoxel(i, 2, 6); delay_ms(200);
      setvoxel(i, 2, 7); delay_ms(200);
      setvoxel(i, 3, 6); delay_ms(200);
      setvoxel(i, 3, 7); delay_ms(200);
      ...
      setvoxel(i, 5, 6); delay_ms(200);
      setvoxel(i, 5, 7); delay_ms(200);
      setvoxel(i, 6, 6); delay_ms(200);
      setvoxel(i, 6, 7); delay_ms(200);
      setvoxel(i, 7, 6); delay_ms(200);
      setvoxel(i, 7, 7); delay_ms(200);
      setvoxel(i, 6, 5); delay_ms(200);
      setvoxel(i, 7, 5); delay_ms(200);
      setvoxel(i, 0, 0); delay_ms(200);
      setvoxel(i, 1, 0); delay_ms(200);
      setvoxel(i, 0, 1); delay_ms(200);
      setvoxel(i, 1, 1); delay_ms(200);
...
void Y() {
  ...
  for (int i = 0; i <= 7; i++) {
    for (int j = 7; j >= 3; j--) {
      setvoxel(i, 3, i - 3); delay_ms(200);
      setvoxel(i, 4, i - 3); delay_ms(200);
      setvoxel(i, 0, j); delay_ms(200);
      setvoxel(i, 1, j); delay_ms(200);
      setvoxel(i, 6, j); delay_ms(200);
      setvoxel(i, 7, j); delay_ms(200);
      ...
      setvoxel(i, 3, 0); delay_ms(200);
      setvoxel(i, 3, 1); delay_ms(200);
      setvoxel(i, 3, 2); delay_ms(200);
      setvoxel(i, 3, 3); delay_ms(200);
      setvoxel(i, 3, 4); delay_ms(200);
      setvoxel(i, 4, 0); delay_ms(200);
      setvoxel(i, 4, 1); delay_ms(200);
      setvoxel(i, 4, 2); delay_ms(200);
      setvoxel(i, 4, 3); delay_ms(200);
      setvoxel(i, 4, 4); delay_ms(200);
    }
  }
...
void B() {
  ...
  for (int i = 0; i <= 7; i++) {
    for (int j = 0; j <= 7; j++) {
      ...
      setvoxel(i, 2, 0); delay_ms(200);
      // setvoxel(0,2,1);
      setvoxel(i, 3, 0); delay_ms(200);
      //setvoxel(0,3,1);
      setvoxel(i, 4, 0); delay_ms(200);
      //setvoxel(0,4,1);
      setvoxel(i, 5, 0); delay_ms(200);
      //setvoxel(0,5,1);
    }
  }
}
...
void D() {
  ...
  for (int i = 0; i <= 7; i++) {
    for (int j = 0; j <= 7; j++) {
      ...
      setvoxel(i, 6, j); delay_ms(200);
      setvoxel(i, 7, j); delay_ms(200);
      setvoxel(i, j, 0); delay_ms(200);
      setvoxel(i, j, 1); delay_ms(200);
      setvoxel(i, j, 6); delay_ms(200);
      setvoxel(i, j, 7); delay_ms(200);
      clrvoxel(i, 7, 0); delay_ms(200);
      clrvoxel(i, 7, 7); delay_ms(200);
      clrvoxel(i, 6, 0); delay_ms(200);
      clrvoxel(i, 6, 7); delay_ms(200);
      clrvoxel(i, 7, 1); delay_ms(200);
      clrvoxel(i, 7, 6); delay_ms(200);
    }
  }
}
